...
Below are the top 10 most important features contributing to the prediction of churn:
...
Below are the summary statistics for customers who churned:
...
with col1:
  ...
  location = st.selectbox("Location", ["Spain", "Germany", "France"],
                          index=["Spain", "Germany", "France"
